...
csv_path = r'D:/WorkSpace/Python_WorkSpace/CMIP_Test/CMIP6/CSV/'+vName+'_'+SSP+'.csv'  # csv输出路径
tif_dir = glob.glob(r'D:/WorkSpace/Python_WorkSpace/CMIP_Test/CMIP6/TIF/Origin/'+vName+'_'+SSP+'/*.tif')  # tif目录
